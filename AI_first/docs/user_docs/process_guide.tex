...
\begin{itemize}
  \item \texttt{Context Launch: Review AI\_first/ui/index.html,} \\
    ...
    \texttt{(default Reviewer/Sponsor, then Project/Process Manager).} \\
...
Default to three terminals or windows: Project Management, Developer, and QA. Keep each perspective visible while AI drafts and you validate the work.
\begin{itemize}
  \item Terminal 1 (Project Management): review the project plan, active phase docs, and action plan in one view; log decisions and keep project actions aligned.
...
\subsection*{AI Prompt Examples}
\begin{itemize}
  \item Project/Process Manager Persona: \\
...
\begin{itemize}
  ...
  \item Developer Persona: execute the active stage action file; analyze root cause and propose fixes in Bug Management; update status as work moves to \texttt{in\_progress} and \texttt{closed}.
